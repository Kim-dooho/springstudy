...
public class MvcController3 {
   ...
   * 2. @RequestParam
   * 3. 커맨트 객체 (요청 파라미터를 필드로 가지고 있는 클래스 타입의 객체)
   */
  ...
  /*
   * @RequestMapping("/param3") public String param3(PageVO page) {
   * 
   * System.out.println(page.getPage()); System.out.println(page.getSort());
   * 
   * return "index"; }
   */
