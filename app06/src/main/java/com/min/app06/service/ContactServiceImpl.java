...
public class ContactServiceImpl implements ContactService {
  ...
  @Override
  public int tx_insertContact(ContactDTO contact) {
    return contactMapper.registerContact(contact);
  }
  @Override
  public int tx_updateContact(ContactDTO contact) {
    return contactMapper.modifyContact(contact);
  }
  @Override
  public int tx_deleteContact(int contactNo) {
  ...
  public void tx_txTest() {
    ...
    // INSERT 성공
    contactMapper.registerContact(new ContactDTO(0, "min1", "min1@example.com", "010-0000-0000", null));
    contactMapper.registerContact(new ContactDTO(0, "min2", "min2@example.com", "010-0000-0000", null));
    contactMapper.registerContact(new ContactDTO(0, "min3", "min3@example.com", "010-0000-0000", null));
