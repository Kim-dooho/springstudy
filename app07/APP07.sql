...
CREATE TABLE upload_t (
  ...
  ip        VARCHAR2(50 BYTE),
  upload_dt DATE,
  CONSTRAINT pk_upload2 PRIMARY KEY(upload_no)
);
CREATE TABLE file_t (
    ...
    upload_no        NUMBER,
    down_count       NUMBER,
    CONSTRAINT pk_file2 PRIMARY KEY(file_no),
    CONSTRAINT fk_file_upload2 FOREIGN KEY(upload_no)
...
-- INNER JOIN : upload_t 과 file_t 에 모두 존재해야만 가능하다.
